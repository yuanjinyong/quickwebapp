...
public class CustomAccessDecisionManager implements AccessDecisionManager {
    ...
    public void decide(Authentication authentication, Object object, Collection<ConfigAttribute> configAttributes)
        ...
        LOG.debug("Request [{}][{}], Need authorities: {}, Granted authorities: {}", method, uri, configAttributes,
        ...
        if (configAttributes.size() == 1) {
            ...
            String needRole = authority.getAttribute();
            if ("UNKOWN_AUTHORITY".equals(needRole)) {
                throw new AccessDeniedException("未配置[" + method + "][" + uri + "]的访问权限，请联系系统管理员！");
            }
        }
        ...
        throw new AccessDeniedException("无[" + method + "][" + uri + "]的访问权限，请联系系统管理员！");
    }
